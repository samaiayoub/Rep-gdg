...
export default function Development() {
  ...
  const [cards, setCards] = useState([
    ...
    },
    {
      ...
      img: "/security.svg",
      to: "/development/apis",
      hue: "linear-gradient(135deg,#eff6ff,#dbeafe)",
      accent: "#1d4ed8",
    },
    {
      id: crypto.randomUUID(),
      name: "Frontend Kits",
      img: "/Pencil.svg",
      to: "/development/frontend-kits",
      hue: "linear-gradient(135deg,#ecfdf5,#bbf7d0)",
      accent: "#16a34a",
    },
    {
      id: crypto.randomUUID(),
      ...
      img: "/Calendar.svg",
      to: "/development/events",
      hue: "linear-gradient(135deg,#fef2ff,#fee2e2)",
      accent: "#f97316",
    },
  ]);
    ...
    >
      ...
      >
        ...
        <section style={{ marginBottom: 18 }}>
          ...
          >
            The Development Department builds and maintains the technical
            backbone of GDG Algiers. From web platforms and internal tools to
            automation and integrations, they ensure every solution is reliable,
            scalable, and aligned with the community&apos;s needs. Working
            closely with other departments, they turn ideas into robust products
            and keep our tech ecosystem running smoothly.
          </p>
        </section>
...
/* Shared UI pieces (same as Design for consistent appearance) */
